  ...
  constructor() {
    ...
    this.setProps({
      onBlur: (e: Event) => {
        ...
        const displayNameRef = this.refs.displayNameInputRef;
        ...
        const errorDisplayNameMessage = validateForm([
          { type: ValidateType.DisplayName, value: imputEl.value },
        ]);
        ...
        if (imputEl.name === 'display_name') {
          displayNameRef.refs.errorRef.setProps({
            text: errorDisplayNameMessage,
          });
      ...
      onSubmit: (e: SubmitEvent) => {
        ...
        const displayNameEl = this.element?.querySelector(
        ...
        if (displayNameEl) {
          ...
          errorDisplayNameMessage
            ? displayNameEl.classList.add('input_type_error')
            : displayNameEl.classList.remove('input_type_error');
        }
    ...
    return `
      <section class="profile">
        ...
        <form class="profile__form">
          ...
          {{{ControlledInput ref="displayNameInputRef" type="text" name="display_name" placeholder="ник" onBlur=onBlur }}}
